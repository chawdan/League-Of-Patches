...
public class MasteryAggregateBean {
	...
	public MasteryAggregateBean(int championId, int wins, int qty, int masteryId, int rank, int division, int assists,
	...
	public static MasteryAggregateBean[] playerMatchBeanToMasteryAggregateBean(PlayerMatchBean bean, RankBean rankBean,
		...
		for (int i = 0; i < items.length; i++) {
			...
			beans.add(new MasteryAggregateBean(championId, wins, qty, itemId.getMasteryId(), rank, division, assists,
					deaths, kills, itemId.getMasteryRank(), laneQty, roleQty, weekDate, yearDate, matchDur));
		}
